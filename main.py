...
def HomePage():
	...
	window.title("HOME - Sign Language Project")
	...
	def exit():
		...
		result = tkMessageBox.askquestion("Sign Language Project", "Are you sure you want to exit?", icon= "warning")
		if result == 'yes':
			sys.exit()
	...
	def VideoMode():
		...
		predict_stream.title("Predict - Sign Language Project")
...
def LoadingScreen():
	...
	root.title("Loading - Sign Language Project")
